<template>
  ...
  <div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    >
      ...
      >
        <!--begin::Logo-->
        <router-link to="/" class="mb-0 mb-lg-12 text-decoration-none d-flex align-items-center">
          <img
            alt="Logo Jamkrida Jabar"
            :src="settingsStore.logoUrl || getAssetPath('media/logos/jamkrida-jabar-official.svg')"
            class="h-60px h-lg-75px me-4"
          />
          <div class="d-flex flex-column text-start">
            <span class="fs-2 fw-bold text-white tracking-wide">Penjaminan Online</span>
            <span class="fs-6 fw-semibold text-warning">Jamkrida Jabar</span>
          </div>
        </router-link>
        <!--end::Logo-->
        ...
        <div class="d-none d-lg-block text-white fs-base text-center">
          Sistem Penjaminan & Klaim Terintegrasi
        </div>
        <!--end::Text-->
      </div>
      <!--end::Content-->
