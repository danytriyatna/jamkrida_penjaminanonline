...
router.beforeEach(async (to, from, next) => {
  ...
  // verify auth token before each page change (only on page reload/first load)
  ...
  if (to.meta.middleware == "auth") {
    ...
    // redirect to dashboard if already authenticated and trying to access guest pages (like sign-in)
